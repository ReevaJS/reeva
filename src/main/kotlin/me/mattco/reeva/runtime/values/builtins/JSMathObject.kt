...
class JSMathObject private constructor(realm: Realm) : JSObject(realm, realm.objectProto) {
    ...
    @JSMethod("max", 2, Descriptor.CONFIGURABLE or Descriptor.WRITABLE)
    ...
    @JSMethod("min", 2, Descriptor.CONFIGURABLE or Descriptor.WRITABLE)
    ...
    @JSMethod("random", 0, Descriptor.CONFIGURABLE or Descriptor.WRITABLE)
