...
class JSDateProto private constructor(realm: Realm) : JSObject(realm.objectProto) {
    override fun init(realm: Realm) {
        super.init(realm)

        defineOwnProperty("constructor", realm.dateCtor, Descriptor.CONFIGURABLE or Descriptor.WRITABLE)
        defineBuiltin(realm, "getDate", 0, ::getDate)
        defineBuiltin(realm, "getDay", 0, ::getDay)
        defineBuiltin(realm, "getFullYear", 0, ::getFullYear)
        defineBuiltin(realm, "getHours", 0, ::getHours)
        defineBuiltin(realm, "getMilliseconds", 0, ::getMilliseconds)
        defineBuiltin(realm, "getMinutes", 0, ::getMinutes)
        defineBuiltin(realm, "getMonth", 0, ::getMonth)
        defineBuiltin(realm, "getSeconds", 0, ::getSeconds)
        defineBuiltin(realm, "getTime", 0, ::getTime)
        defineBuiltin(realm, "getTimezoneOffset", 0, ::getTimezoneOffset)
        defineBuiltin(realm, "getUTCDate", 0, ::getUTCDate)
        defineBuiltin(realm, "getUTCFullYear", 0, ::getUTCFullYear)
        defineBuiltin(realm, "getUTCHours", 0, ::getUTCHours)
        defineBuiltin(realm, "getUTCMilliseconds", 0, ::getUTCMilliseconds)
        defineBuiltin(realm, "getUTCMinutes", 0, ::getUTCMinutes)
        defineBuiltin(realm, "getUTCMonth", 0, ::getUTCMonth)
        defineBuiltin(realm, "getUTCSeconds", 0, ::getUTCSeconds)
        defineBuiltin(realm, "setDate", 1, ::setDate)
        defineBuiltin(realm, "setFullYear", 3, ::setFullYear)
        defineBuiltin(realm, "setHours", 4, ::setHours)
        defineBuiltin(realm, "setMilliseconds", 1, ::setMilliseconds)
        defineBuiltin(realm, "setMonth", 2, ::setMonth)
        defineBuiltin(realm, "setSeconds", 2, ::setSeconds)
        defineBuiltin(realm, "setTime", 2, ::setTime)
        defineBuiltin(realm, "setUTCDate", 1, ::setUTCDate)
        defineBuiltin(realm, "setUTCFullYear", 3, ::setUTCFullYear)
        defineBuiltin(realm, "setUTCHours", 4, ::setUTCHours)
        defineBuiltin(realm, "setUTCMilliseconds", 1, ::setUTCMilliseconds)
        defineBuiltin(realm, "setUTCMinutes", 3, ::setUTCMinutes)
        defineBuiltin(realm, "setUTCMonth", 2, ::setUTCMonth)
        defineBuiltin(realm, "setUTCSeconds", 2, ::setUTCSeconds)
        defineBuiltin(realm, "toDateString", 0, ::toDateString)
        defineBuiltin(realm, "toISOString", 0, ::toISOString)
        defineBuiltin(realm, "toJSON", 1, ::toJSON)
        defineBuiltin(realm, "toString", 0, ::toString)
        defineBuiltin(realm, "toTimeString", 0, ::toTimeString)
        defineBuiltin(realm, "toUTCString", 0, ::toUTCString)
        defineBuiltin(realm, "valueOf", 0, ::valueOf)
        defineBuiltin(realm, Realm.WellKnownSymbols.toPrimitive, 0, ::symbolToPrimitive, attrs { +conf; -enum })
    }
    ...
    companion object {
        ...
        fun create(realm: Realm) = JSDateProto(realm).initialize(realm)
