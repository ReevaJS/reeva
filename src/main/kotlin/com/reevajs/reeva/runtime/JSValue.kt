...
fun JSValue.exp(realm: Realm, other: JSValue) = Operations.exp(realm, this, other)
fun JSValue.mul(realm: Realm, other: JSValue) = Operations.mul(realm, this, other)
fun JSValue.div(realm: Realm, other: JSValue) = Operations.div(realm, this, other)
fun JSValue.mod(realm: Realm, other: JSValue) = Operations.mod(realm, this, other)
fun JSValue.add(realm: Realm, other: JSValue) = Operations.add(realm, this, other)
fun JSValue.sub(realm: Realm, other: JSValue) = Operations.sub(realm, this, other)
fun JSValue.shl(realm: Realm, other: JSValue) = Operations.shl(realm, this, other)
fun JSValue.shr(realm: Realm, other: JSValue) = Operations.shr(realm, this, other)
fun JSValue.ushr(realm: Realm, other: JSValue) = Operations.ushr(realm, this, other)
fun JSValue.and(realm: Realm, other: JSValue) = Operations.and(realm, this, other)
fun JSValue.xor(realm: Realm, other: JSValue) = Operations.xor(realm, this, other)
fun JSValue.or(realm: Realm, other: JSValue) = Operations.or(realm, this, other)
fun JSValue.isLessThan(realm: Realm, other: JSValue) = Operations.isLessThan(realm, this, other)
fun JSValue.isLessThanOrEqual(realm: Realm, other: JSValue) = Operations.isLessThanOrEqual(realm, this, other)
fun JSValue.isGreaterThan(realm: Realm, other: JSValue) = Operations.isGreaterThan(realm, this, other)
fun JSValue.isGreaterThanOrEqual(realm: Realm, other: JSValue) = Operations.isGreaterThanOrEqual(realm, this, other)