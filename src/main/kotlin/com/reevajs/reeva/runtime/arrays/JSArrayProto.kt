...
class JSArrayProto private constructor(realm: Realm) : JSArrayObject(realm, realm.objectProto) {
    override fun init() {
        ...
        defineBuiltin("at", 1, Builtin.ArrayProtoAt)
        defineBuiltin("concat", 1, Builtin.ArrayProtoConcat)
        defineBuiltin("copyWithin", 2, Builtin.ArrayProtoCopyWithin)
        defineBuiltin("entries", 0, Builtin.ArrayProtoEntries)
        defineBuiltin("every", 1, Builtin.ArrayProtoEvery)
        defineBuiltin("fill", 1, Builtin.ArrayProtoFill)
        defineBuiltin("filter", 1, Builtin.ArrayProtoFilter)
        defineBuiltin("find", 1, Builtin.ArrayProtoFind)
        defineBuiltin("findIndex", 1, Builtin.ArrayProtoFindIndex)
        defineBuiltin("flat", 0, Builtin.ArrayProtoFlat)
        defineBuiltin("flatMap", 1, Builtin.ArrayProtoFlatMap)
        defineBuiltin("forEach", 1, Builtin.ArrayProtoForEach)
        defineBuiltin("includes", 1, Builtin.ArrayProtoIncludes)
        defineBuiltin("indexOf", 1, Builtin.ArrayProtoIndexOf)
        defineBuiltin("join", 1, Builtin.ArrayProtoJoin)
        defineBuiltin("keys", 1, Builtin.ArrayProtoKeys)
        defineBuiltin("lastIndexOf", 1, Builtin.ArrayProtoLastIndexOf)
        defineBuiltin("map", 1, Builtin.ArrayProtoMap)
        defineBuiltin("pop", 1, Builtin.ArrayProtoPop)
        defineBuiltin("push", 1, Builtin.ArrayProtoPush)
        defineBuiltin("reduce", 1, Builtin.ArrayProtoReduce)
        defineBuiltin("reduceRight", 1, Builtin.ArrayProtoReduceRight)
        defineBuiltin("reverse", 1, Builtin.ArrayProtoReverse)
        defineBuiltin("shift", 1, Builtin.ArrayProtoShift)
        defineBuiltin("slice", 1, Builtin.ArrayProtoSlice)
        defineBuiltin("some", 1, Builtin.ArrayProtoSome)
        defineBuiltin("splice", 1, Builtin.ArrayProtoSplice)
        defineBuiltin("toString", 1, Builtin.ArrayProtoToString)
        defineBuiltin("unshift", 1, Builtin.ArrayProtoUnshift)
        defineBuiltin("values", 1, Builtin.ArrayProtoValues)
