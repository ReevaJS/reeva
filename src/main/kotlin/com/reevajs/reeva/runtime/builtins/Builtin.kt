...
internal enum class Builtin(clazz: Class<*>, name: String, val type: Type = Type.Normal) {
    ArrayCtorGetSymbolSpecies(JSArrayCtor::class.java, "get@@species", type = Type.Getter),
    ...
    ArrayBufferCtorGetSymbolSpecies(JSArrayBufferCtor::class.java, "get@@species", type = Type.Getter),
    ArrayBufferProtoGetByteLength(JSArrayBufferProto::class.java, "getByteLength", type = Type.Getter),
    ...
    DataViewProtoGetBuffer(JSDataViewProto::class.java, "getBuffer", type = Type.Getter),
    DataViewProtoGetByteLength(JSDataViewProto::class.java, "getByteLength", type = Type.Getter),
    DataViewProtoGetByteOffset(JSDataViewProto::class.java, "getByteOffset", type = Type.Getter),
    ...
    JSONGetSymbolToStringTag(JSONObject::class.java, "get@@toStringTag", type = Type.Getter),

    ListIteratorProtoNext(JSListIteratorProto::class.java, "next"),

    MapCtorGetSymbolSpecies(JSMapCtor::class.java, "get@@species", type = Type.Getter),
    ...
    MapProtoGetSize(JSMapProto::class.java, "getSize", type = Type.Getter),
    ...
    ObjectProtoGetProto(JSObjectProto::class.java, "getProto", type = Type.Getter),
    ObjectProtoSetProto(JSObjectProto::class.java, "setProto", type = Type.Setter),
    ...
    RegExpCtorGetSpecies(JSRegExpCtor::class.java, "get@@species", type = Type.Getter),
    RegExpProtoGetDotAll(JSRegExpProto::class.java, "getDotAll", type = Type.Getter),
    RegExpProtoGetFlags(JSRegExpProto::class.java, "getFlags", type = Type.Getter),
    RegExpProtoGetGlobal(JSRegExpProto::class.java, "getGlobal", type = Type.Getter),
    RegExpProtoGetIgnoreCase(JSRegExpProto::class.java, "getIgnoreCase", type = Type.Getter),
    RegExpProtoGetMultiline(JSRegExpProto::class.java, "getMultiline", type = Type.Getter),
    RegExpProtoGetSource(JSRegExpProto::class.java, "getSource", type = Type.Getter),
    RegExpProtoGetSticky(JSRegExpProto::class.java, "getSticky", type = Type.Getter),
    RegExpProtoGetUnicode(JSRegExpProto::class.java, "getUnicode", type = Type.Getter),
    ...
    SetCtorGetSymbolSpecies(JSSetCtor::class.java, "get@@species", type = Type.Getter),
    SetProtoGetSize(JSSetProto::class.java, "getSize", type = Type.Getter),
    ...
    TypedArrayProtoGetSymbolToStringTag(JSTypedArrayProto::class.java, "get@@toStringTag", type = Type.Getter),
    TypedArrayProtoGetBuffer(JSTypedArrayProto::class.java, "getBuffer", type = Type.Getter),
    TypedArrayProtoGetByteLength(JSTypedArrayProto::class.java, "getByteLength", type = Type.Getter),
    TypedArrayProtoGetByteOffset(JSTypedArrayProto::class.java, "getByteOffset", type = Type.Getter),
    TypedArrayProtoGetLength(JSTypedArrayProto::class.java, "getLength", type = Type.Getter),
    ...
    val handle: MethodHandle = MethodHandles.publicLookup().findStatic(clazz, name, type.methodType)

    enum class Type(val methodType: MethodType) {
        Normal(MethodType.methodType(JSValue::class.java, Realm::class.java, JSArguments::class.java)),
        Getter(MethodType.methodType(JSValue::class.java, Realm::class.java, JSValue::class.java)),
        Setter(MethodType.methodType(JSValue::class.java, Realm::class.java, JSValue::class.java, JSValue::class.java)),
    }
