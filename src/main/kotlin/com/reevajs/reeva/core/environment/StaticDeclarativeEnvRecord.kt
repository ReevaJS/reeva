...
// Optimized version of DeclarativeEnvRecord that operates on static indices. Not
// usable for global environment, or any environment with eval present.
open class StaticDeclarativeEnvRecord(
    ...
    @ECMAImpl("9.1.1.1.1")
    override fun hasBinding(name: EnvRecordKey) = bindings.getOrNull(name as Int) != null
    ...
    override fun createMutableBinding(name: EnvRecordKey, deletable: Boolean) {
        ...
        bindings[name as Int] = Binding().apply { isDeletable = true }
    ...
    override fun createImmutableBinding(name: EnvRecordKey, isStrict: Boolean) {
        ...
        bindings[name as Int] = Binding().apply { this.isStrict = isStrict }
    ...
    override fun initializeBinding(name: EnvRecordKey, value: JSValue) {
        val binding = bindings[name as Int]
